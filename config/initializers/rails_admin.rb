# RailsAdmin config file. Generated on January 23, 2014 18:40
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Amazon', 'Admin']
  ...
  # config.included_models = ["Book", "Order", "Author", "Category", "Rating"]
  ...
  # config.excluded_models = ['Address', 'Author', 'Book', 'Category', 'Country', 'CreditCard', 'Customer', 'Order', 'OrderItem', 'Rating']

  # Include specific models (exclude the others):
  # config.included_models = ['Address', 'Author', 'Book', 'Category', 'Country', 'CreditCard', 'Customer', 'Order', 'OrderItem', 'Rating']
  ...
  #     configure :cvv, :integer 
  #     configure :expiration_month, :string 
  #     configure :expiration_year, :integer 
